  ...
  return (
    <div className='Navbar'>
        ...
        <div className='head'>
          ...
          <button className={defaulth === 'Garbage Nearby'? 'selectedpgchoice' : 'onlychoice'} onClick={(e) => {navigate('/garbagecollectornearby');}} value="Garbage Nearby">Garbage Collectors Nearby</button>
